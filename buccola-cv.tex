...
\begin{cvsection}
  ...
  Journals & \emph{Acta Linguistica Academica}, \emph{Glossa} (5x), \emph{Journal of Semantics} (3x), \emph{Language and Linguistics Compass}, \emph{Linguistics and Philosophy} (2x), \emph{Natural Language Semantics} (2x), \emph{Semantics and Pragmatics} (5x).\\
