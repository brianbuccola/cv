...
{\footnotesize
  ...
  \begin{minipage}[t]{0.32\textwidth}
    ...
    \Telefon\ +33 6 95 32 67 62 {\footnotesize (France)}\\
...
\begin{cvsection}
  2017-- & \parbox[t]{\bodywidth\textwidth}{%
    Postdoctoral researcher, Laboratoire de Sciences Cognitives et Psycholinguistique {\footnotesize (ENS, EHESS, CNRS)}, Département d'Études Cognitives, École Normale Supérieure, PSL Research University.
  }\\
...
\begin{cvsection}
  submitted & \fullcite{buccola.haida2017sp}.\\
  in revision & \fullcite{buccola2017barenum}.\\
  in revision & \fullcite{buccola.etal2016}.\\
