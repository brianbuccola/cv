...
\newcommand{\cvitem}[2]{%
  ...
  \begin{minipage}[t]{0.74\textwidth}
    \hspace{0pt}#2 % item details go here
  \end{minipage}
}
...
\cvitem{2013 {\footnotesize (to appear)}}{\bibentry{buccola2013fg}.}

\cvitem{2012}{\bibentry{schwarz.etal2012}.}



\section*{Unpublished papers}

\cvitem{2013}{\bibentry{buccola2013eval2}.}

\cvitem{2012}{\bibentry{buccola2012eval1}.}



\section*{Refereed presentations}

\cvitem{\formatdate{16}{3}{2013}}{\bibentry{buccola2013mot}.}

\cvitem{\formatdate{10}{3}{2012}}{\bibentry{buccola2012tom}.}

\cvitem{\formatdate{9}{4}{2011}}{\bibentry{buccola2011tom}.}



\section*{Non--refereed presentations}

\cvitem{\formatdate{5}{11}{2012}}{\name. ``Formalization in linguistics''.
Invited lecture. Brendan Gillon's pragmatics course (LING 565).  McGill
University.}

\cvitem{\formatdate{31}{7}{2012}}{\name. ``Some remarks on inference patterns
involving epistemic modality'', part 2. Syntax--Semantics Research Group.
McGill University.}

\cvitem{\formatdate{11}{7}{2012}}{\name. ``Some remarks on inference patterns
involving epistemic modality'', part 1. Syntax--Semantics Research Group.
McGill University.}

\cvitem{\formatdate{25}{11}{2012}}{\name. ``On Cummins and Katsos (2010):
Comparative and superlative quantifiers: Pragmatic effects of comparison
type''.  Syntax--Semantics Research Group. McGill University.}

\cvitem{\formatdate{22}{6}{2011}}{\name, Michael Hamilton, and Bernhard
Schwarz.  ``On Nouwen (2010): Two kinds of modified numerals'', part 2.
Syntax--Semantics Research Group. McGill University.}

\cvitem{\formatdate{8}{6}{2011}}{\name, Michael Hamilton, and Bernhard Schwarz.
``On Nouwen (2010): Two kinds of modified numerals'', part 1.
Syntax--Semantics Research Group. McGill University.}
