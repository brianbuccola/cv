...
\begin{cvsection}
  ...
  Journals & \emph{Acta Linguistica Academica}, \emph{Glossa} (3x), \emph{Journal of Semantics} (2x), \emph{Language and Linguistics Compass}, \emph{Linguistics and Philosophy} (3x), \emph{Natural Language Semantics} (2x), \emph{Semantics and Pragmatics} (5x).\\
