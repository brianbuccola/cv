...
%                                                                              %
%  file:   buccola-cv.tex                                                      %
%  author: Brian Buccola <brian.buccola@msu.edu>                               %
%                                                                              %
%==============================================================================%
...
\begin{cvsection}
  in prep. & \fullcite{buccola.goodhue2023cls}.\\
  in prep. & \fullcite{cong.buccola2023cost}.\\
  in prep. & \fullcite{wang.buccola2023wccfl}.\\
...
\begin{cvsection}
  upcoming & \fullcite{wang.buccola2023wccflposter}.\\
  upcoming & \fullcite{buccola.goodhue2023clsposter}.\\
...
\begin{cvsection}
  in progress & Shannon Cousins (chair).\\
  in progress & Jiasheng Guo (chair).\\
...
\begin{cvsection}
  in progress & Komeil Kolahi Ahari, Adam Barnhardt, Yunting Gu, Josh Herrin, John Ryan, Jason Smith, Jingying Xu.\\
...
\begin{cvsection}
  in progress & CJ Sivak. ``The Semantics and Pragmatics of Rising Intonation''.\\
...
\begin{cvsection}
  ...
  \datebox{%
    Conferences\\
    {\footnotesize (ad hoc)}
  } & Canadian Linguistic Association (CLA), Experimental approaches to language universals in structure and meaning (ExUni), GLOW in Asia, Israel Association for Theoretical Linguistics (IATL), Seoul International Conference on Generative Grammar (SICOGG).\\
\end{cvsection}
