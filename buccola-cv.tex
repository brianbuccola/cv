...
\usepackage{sectsty}
\sectionfont{\rmfamily\mdseries\scshape\large \sectionrule{0pt}{0pt}{-1ex}{1pt}}
...
\begin{cvsection}
  2013 & \hspace{0pt}\bibentry{buccola2013fg}.
...
\begin{cvsection}
  ...
  Research Group. McGill University, \formatdate{25}{11}{2012}. \\
  ...
  McGill University, \formatdate{22}{6}{2011}. \\

  2011 & \name, Michael Hamilton, and Bernhard Schwarz.  ``On Nouwen (2010):
  Two kinds of modified numerals'', part 1.  Syntax--Semantics Research Group.
  McGill University, \formatdate{8}{6}{2011}.
\end{cvsection}
