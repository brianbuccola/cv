...
\begin{cvsection}
  forthcoming & \fullcite{chemla.buccola.dautriche2018}.\\
...
\begin{cvsection}
  under review (after minor revisions) & \fullcite{buccola.haida2018oi}.\\
  under review (after minor revisions) & \fullcite{buccola.dautriche.chemla2018}.\\
  under review & \fullcite{buccola.kriz.chemla2018}.\\
  in revision & \fullcite{chemla.etal2018}.\\
...
\begin{cvsection}
  in prep. & \fullcite{anvari.buccola.haida2018sub}.\\
...
\begin{cvsection}
  ...
  Reviewer (journals) & \emph{Acta Linguistica Academica} (1 journal article manuscript, 2017), \emph{Glossa} (3 journal article manuscripts, 2017--2018), \emph{Journal of Semantics} (2 journal article manuscripts, 2015--2016), \emph{Linguistics and Philosophy} (1 journal article manuscript, 2018), \emph{Semantics and Pragmatics} (3 journal article manuscripts, 2016--2018).\\
  Reviewer (conferences) & \emph{GLOW in Asia} (2016), \emph{Israel Association for Theoretical Linguistics} (2016--2018), \emph{North East Linguistic Society} (2015--2017), \emph{Semantics and Linguistic Theory} (2018), \emph{Sinn und Bedeutung} (2017--2018).
\end{cvsection}
