...
\begin{cvsection}
  ...
  Reviewer (journals) & \emph{Acta Linguistica Academica}, \emph{Glossa} (3x), \emph{Journal of Semantics} (2x), \emph{Linguistics and Philosophy}, \emph{Semantics and Pragmatics} (4x).\\
