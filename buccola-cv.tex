...
\addtolength{\LTpost}{0.5ex} % glue after longtable
...
\begin{cvsection}
  ...
  \begin{minipage}{0.75\textwidth}
    \medskip
    Dissertation: \textit{Maximality and Modified Numerals} {\small (in
      progress)} \\
    Supervisors:
...
\begin{cvsection}
  ...
  [\href{http://people.linguistics.mcgill.ca/~brian.buccola/files/buccola2013fg.pdf}{preprint}] \\
...
\begin{cvsection}
  ...
  2014 & \null\bibentry{buccola2014ms}. \\

  2013 & \null\bibentry{buccola2013eval2}.
  [\href{http://people.linguistics.mcgill.ca/~brian.buccola/files/buccola2013eval2.pdf}{draft}] \\

  2012 & \null\bibentry{buccola2012eval1}.
  [\href{http://people.linguistics.mcgill.ca/~brian.buccola/files/buccola2012eval1.pdf}{draft}] \\
\end{cvsection}
