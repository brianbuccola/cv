...
\subsubsection*{Under review or in revision}

\begin{cvsection}
  2020 & \fullcite{buccola.kuhn.nicolas2020}.\\
  2019 & \fullcite{buccola.crnic2019}.\\
  2018 & \fullcite{buccola.kriz.chemla2018}.\\
...
\begin{cvsection}
  2020 & \fullcite{buccola.haida2020oi2}.\\
  2019 & \fullcite{anvari.buccola.haida2019}.\\
\end{cvsection}
...
\begin{cvsection}
  ...
  upcoming & \fullcite{buccola.haida2020oi2salt}.\\
...
\begin{cvsection}
  ...
  Ph.D. & Abudushalamu, Xiayimaierdan. \emph{Uyghur and Mandarin Chinese code-switching: A game-theoretic analysis} (working title). In progress. (Co-chair with Suzanne Wagner)
\end{cvsection}
...
\begin{cvsection}
  ...
  M.A. & 1 student in progress (phonetics, computational modeling).\\
\end{cvsection}
...
\begin{cvsection}
  Books & The MIT Press (1 book manuscript).\\
  Journals & \emph{Acta Linguistica Academica}, \emph{Glossa} (3x), \emph{Journal of Semantics} (2x), \emph{Linguistics and Philosophy} (3x), \emph{Natural Language Semantics} (2x), \emph{Semantics and Pragmatics} (5x).\\
