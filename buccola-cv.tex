...
\usepackage[osf]{Baskervaldx}% Baskerville font, with old-style figures
\usepackage[baskervaldx]{newtxmath}% Math font for Baskerville
\usepackage{nimbusmononarrow}% Nimbus Mono Narrow
...
\begin{flushleft}
  \pbox[t]{\textwidth}{%
    Department of Linguistics \emph{\&} Languages\\
