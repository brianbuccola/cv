...
\begin{cvsection}
  in prep. & \fullcite{buccola2025num}.
\end{cvsection}
...
\begin{cvsection}
  in progress & Komeil Kolahi Ahari, Mofart Ayiega, Adam Barnhardt, Annan Kirk, John Ryan, Jessica Shepherd, Jingying Xu.\\
...
\begin{cvsection}
  2024-- & Convenor for Linguistics program (2-year elected position).\\
  2024 & Member, Summer fellowship review subcommittee.\\
  2024 & Member, Graduate admissions subcommittee (for Fall 2024).\\
  2022--2024 & Convenor for Linguistics program (2-year elected position).\\
