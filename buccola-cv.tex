...
\begin{cvsection}
  2017-- & \parbox[t]{\bodywidth\textwidth}{%
    Chercheur postdoctoral, Laboratoire de Sciences Cognitives et Psycholinguistique, École Normale Supérieure.
  }\\
  ...
  \parbox[t]{\datewidth\textwidth}{%
    ...
    Chercheur invité, Institut Jean Nicod, École Normale Supérieure.\\
...
\subsection*{Articles dans des revues et manuscrits}
