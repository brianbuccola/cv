...
\usepackage{sectsty}
\sectionfont{\needspace{4\baselineskip} \rmfamily\mdseries\scshape\large \sectionrule{0pt}{0pt}{-1ex}{1pt}}
\subsectionfont{\needspace{4\baselineskip} \rmfamily\mdseries\scshape\normalsize}
...
\begin{cvsection}
  Linux shell {\small (Bash, Zsh)} & Advanced \\
  \LaTeX{} & Proficient \\
  HTML/CSS & Proficient \\
  Haskell & Basic \\
  Python & Basic
