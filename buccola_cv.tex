...
\usepackage[scaled=0.83]{beramono}% Bera mono (typewriter) font, scaled down
...
\begin{cvsection}
  {\small in press} & \fullcite{buccola.spector2016}.\\
...
\begin{cvsection}
  {\small in press} & \fullcite{buccola2016sub}.\\
